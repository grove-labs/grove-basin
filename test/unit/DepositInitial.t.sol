...
contract DepositInitialTests is GroveBasinTestBase {
    ...
    function test_depositInitial_invalidAsset() public {
        ...
        freshBasin.depositInitial(makeAddr("bad-asset"), address(this), 100e6);
    }
    ...
    function test_depositInitial_anyoneCanCall() public {
        ...
        swapToken.approve(address(freshBasin), 100e6);
        uint256 newShares = freshBasin.depositInitial(address(swapToken), anyone, 100e6);
        vm.stopPrank();
    ...
    function test_depositInitial_swapToken() public {
        ...
        uint256 newShares = freshBasin.depositInitial(address(swapToken), depositor, 100e6);
        vm.stopPrank();
    ...
    function test_depositInitial_collateralToken() public {
        ...
        uint256 newShares = freshBasin.depositInitial(address(collateralToken), depositor, 100e18);
        vm.stopPrank();
    ...
    function test_depositInitial_creditToken() public {
        ...
        uint256 newShares = freshBasin.depositInitial(address(creditToken), depositor, 100e18);
        vm.stopPrank();
    ...
    function testFuzz_depositInitial_swapToken(uint256 amount) public {
        ...
        uint256 newShares = freshBasin.depositInitial(address(swapToken), depositor, amount);
        vm.stopPrank();
    ...
    function testFuzz_depositInitial_collateralToken(uint256 amount) public {
        ...
        uint256 newShares = freshBasin.depositInitial(address(collateralToken), depositor, amount);
        vm.stopPrank();
    ...
    function testFuzz_depositInitial_creditToken(uint256 amount) public {
        ...
        uint256 newShares = freshBasin.depositInitial(address(creditToken), depositor, amount);
        vm.stopPrank();
