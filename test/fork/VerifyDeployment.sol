...
library Deployments {
    ...
    address internal constant PAU_ALM_PROXY                = 0x0DcD9298e163dFD3c0B5b00F0d9093C36e40A153;
...
abstract contract Verify_Actions is UsdsUsdcBasinDeploymentForkTestBase {
    ...
    function test_action_swapExactIn_creditToSwap() public {
        ...
        _dealCreditToken(Deployments.PAU_ALM_PROXY, amountIn);

        vm.startPrank(Deployments.PAU_ALM_PROXY);
    ...
    function test_action_swapExactOut_creditToSwap() public {
        ...
        _dealCreditToken(Deployments.PAU_ALM_PROXY, expectedIn);
